...
const toastStyles = {
  success: 'bg-status-success/90 border-status-success text-white',
  error: 'bg-status-danger/90 border-status-danger text-white',
  info: 'bg-status-info/90 border-status-info text-white',
  warning: 'bg-status-warning/90 border-status-warning text-white'
};
